...
import com.wapitia.games.worddivision.model.*
import com.wapitia.games.worddivision.standard.BuildCache
import com.wapitia.games.worddivision.standard.StandardTextUtility.spaces

import com.wapitia.games.worddivision.model.builder.TableauBuildException as TBE
import com.wapitia.games.worddivision.model.builder.TableauBuildProblem.MissingQuotient
import com.wapitia.games.worddivision.model.builder.TableauBuildProblem.MissingDividend
import com.wapitia.games.worddivision.model.builder.TableauBuildProblem.MissingDivisor
import com.wapitia.games.worddivision.model.builder.TableauBuildProblem.RowTooLong
import com.wapitia.games.worddivision.model.builder.TableauBuildProblem.MissingRemainderRow
import com.wapitia.games.worddivision.solution.SolutionLetter

import kotlin.math.max

/**
 * Builds a {@link Tableau} by accumulating long-division sections in the
...
class TextTableauBuilder(
    ...
    fun subtraction(subtrahend: String, minuend: String) = apply {
        rows.add(subtrahend)
        rows.add(minuend)
    }
    fun remainder(remainder: String) = row(remainder)
    ...
    private fun buildSubrow(str: String, width: Int, accum: Accums): CellRow {
        ...
        val cells: Sequence<Cell> = List(width) { i ->
            if (i < blankPrefix) Cell.blankCell()
...
internal class Accums {
    val letterCache: BuildCache<Char, Letter> = BuildCache { c -> SolutionLetter(c) }
